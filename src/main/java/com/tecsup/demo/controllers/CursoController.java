...
public class CursoController {
    ...
    public String listarCurso(Model model) {
        ...
        model.addAttribute("searchAction", "/curso/buscar");
        return "listar";
    }

    @GetMapping("/curso/buscar")
    public String buscarCurso(@RequestParam("q") String query, Model model) {
        List<Curso> resultados = cursoService.buscarPorNombre(query);
